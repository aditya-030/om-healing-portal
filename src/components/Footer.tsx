        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-1">
            ...
            <div className="flex mt-2 space-x-4">
              <a href="https://wa.me/91XXXXXXXXXX" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                <WhatsAppIcon size={22} className="text-gray-500 hover:text-om-green" />
              </a>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-700">
              <li><Link to="/" className="hover:text-om-green transition-colors">Home</Link></li>
              <li><Link to="/about" className="hover:text-om-green transition-colors">About</Link></li>
              <li><Link to="/services" className="hover:text-om-green transition-colors">Services</Link></li>
              <li><Link to="/testimonials" className="hover:text-om-green transition-colors">Testimonials</Link></li>
              <li><Link to="/gallery" className="hover:text-om-green transition-colors">Vlogs / Gallery</Link></li>
              <li><Link to="/contact" className="hover:text-om-green transition-colors">Contact</Link></li>
              <li><Link to="/patient-dashboard" className="hover:text-om-green transition-colors">Patient Login</Link></li>

      ...
      <div className="container relative z-10 mx-auto px-4 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <Link
              to="/appointment"
              className="bg-om-green hover:bg-om-lightGreen text-white font-medium px-6 py-3 rounded-md transition-all duration-300 text-center"
            >
              Book an Appointment
            </Link>
            <Link
              to="/services"
              className="bg-white border border-om-green text-om-green hover:bg-om-green hover:text-white font-medium px-6 py-3 rounded-md transition-all duration-300 text-center"
            >
              Our Services
            </Link>
          </div>
